...
* soaplib-0.8 branch: https://github.com/soaplib/soaplib/tree/0_8
* soaplib-1.0 branch: https://github.com/soaplib/soaplib/tree/1_0
...
contact us on the `mailing list <http://mail.python.org/mailman/listinfo/soap/>`
and we'll help.
